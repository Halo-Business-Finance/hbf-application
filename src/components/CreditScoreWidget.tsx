...
export const CreditScoreWidget = () => {
  ...
  if (isLoading) {
    return (
      <Card className="border-2 border-blue-950 shadow-sm overflow-hidden bg-white rounded-lg">
  ...
  return (
    <Card className="border-2 border-blue-950 shadow-sm hover:shadow-md transition-all duration-200 overflow-hidden bg-white rounded-lg">
      <CardHeader className="bg-blue-950">
        <CardTitle className="text-sm font-semibold uppercase tracking-wide text-white flex items-center gap-2">
          <Activity className="w-4 h-4" />
          Credit Scores
