...
export const DashboardCharts = ({ userId, className }: DashboardChartsProps) => {
  const [statusData, setStatusData] = useState<{ name: string; value: number; color: string }[]>([]);
  const [monthlyData, setMonthlyData] = useState<{ month: string; applications: number }[]>([]);
    ...
    const fetchChartData = async () => {
      ...
      try {
        ...
        if (applications) {
          ...
          setMonthlyData(
            Object.entries(monthlyCounts).map(([key, count]) => {
