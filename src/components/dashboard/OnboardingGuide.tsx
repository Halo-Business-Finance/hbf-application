...
export const OnboardingGuide = ({ userId, onDismiss, className }: OnboardingGuideProps) => {
  ...
  return (
    <Card className={cn(
      "border-primary/20 bg-gradient-to-r from-primary/5 to-accent/5 animate-fade-in",
      className
    )}>
      <CardContent className="p-6">
        ...
        <div className="mb-6">
          <div className="flex items-center justify-between text-sm mb-2">
            ...
            <span className="font-medium text-primary">{completedCount}/{steps.length} completed</span>
          </div>
            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  "border border-border hover:border-primary/30 hover:bg-background",
                  step.completed && "bg-green-50 border-green-200 dark:bg-green-900/20"
                )}
